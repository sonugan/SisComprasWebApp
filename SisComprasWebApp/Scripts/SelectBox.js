...
(function($){
	...
	window.SelectBox = function(options){
		...
		function init() {
			...
			$customSelect.width(cfg.width+"%"); /* Modificado por Sofrecom para que tome ancho variable */
			$dl.width(cfg.width+"%" - 2); /* Modificado por Sofrecom para que tome ancho variable */
